...
static constexpr std::uint8_t DEVICE_ID_0 = 0x90;
static constexpr std::uint8_t DEVICE_ID_1 = 0x64;
static constexpr std::uint8_t I2C_ADDR = 0x32;
...
bool update(void)
{
  ...
  M5.Display.drawString("Unit Thermal2", 0, 0);
...
void setup(void)
{
  ...
  M5.Display.println("search Unit Thermal2.");
  Serial.println("search Unit Thermal2.");
}
